...
function cargarDatosjson (){   
    $str = file_get_contents(FILEUSER);
    $tabla = json_decode($str, true);
    return $tabla;
}

function volcarDatosjson($tvalores){
    $str = json_encode($tvalores);
    file_put_contents(FILEUSER, $str);    
}
